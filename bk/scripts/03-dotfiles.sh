...
# ---- fastfetch on new shells (comment out if you find it noisy) ----
if command -v fastfetch >/dev/null 2>&1 && [[ -o interactive ]] && [[ -z "$FASTFETCH_SHOWN" ]]; then
  fastfetch
